...
def launch_train(args, config):
    ...
    #     "python",
    #     "-u",
    #     #os.path.join(get_mmf_root(), "..", "mmf_cli", "predict.py"),
    #     os.path.join(Path().absolute(), "mmf_cli", "run.py"),
    # ]
    ...
    if args.local:
        ...
        if not args.salloc:
            ...
            sbatch_cmd = [
                ...
                "B:USR1@180",
                "--exclude",
                "a100-st-p4d24xlarge-58,a100-st-p4d24xlarge-15,a100-st-p4d24xlarge-83,a100-st-p4d24xlarge-9"
            ]
            if args.constraint:
