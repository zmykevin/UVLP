...
def get_args(argv=None):
    ...
    parser.add_argument("--gpu-type", default="tesla") #setting for AWS Cluster
    parser.add_argument(
        "--constraint",
        metavar="CONSTRAINT",
    ...
    parser.add_argument(
        "--checkpoint_path",
        default="something",
        help="the checkpoint_path to resume the checkpoint file",
        type=str,
        )
...
def main(get_grid, postprocess_hyperparams):
    ...
    # print(args.checkpoint.resume_file)
