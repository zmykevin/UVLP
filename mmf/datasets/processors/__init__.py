...
from mmf.datasets.processors.bert_processors import MaskedTokenProcessor,MaskedTokenImageProcessor, MaskedTokenImageTagProcessor
...
__all__ = [
    ...
    "MaskedTokenImageProcessor",
    "MaskedTokenImageTagProcessor",
